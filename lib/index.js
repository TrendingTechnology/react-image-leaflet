...
var PanZoom = /** @class */ (function (_super) {
    ...
    function PanZoom() {
        ...
        _this.options = {
            ...
            doubleClickZoom: _this.props.doubleClickZoom === undefined ||
                _this.props.doubleClickReset === undefined
                ? true
                : _this.props.doubleClickReset === true
                    ? false
        ...
        _this.draw = function (url) {
            ...
            img.onload = function () {
                ...
                if (_this.props.doubleClickReset) {
        ...
        _this.render = function () {
            return (react_1.default.createElement(Container, { ref: _this.outRef, bgColor: _this.bgColor, margin: _this.margin, padding: _this.padding },
                ...
                react_1.default.createElement(Map, { id: "map" })));
        };
        return _this;
    }
    return PanZoom;
