...
var PanZoom = /** @class */ (function (_super) {
    ...
    function PanZoom(props) {
        ...
        _this.delay = _this.props.delay ? 200 : _this.props.delay;
        _this.options = {
        ...
        _this.onResize = function () {
            ...
            if (node) {
                var width_1 = node.clientWidth;
                var height_1 = node.clientHeight;
                if (_this.timer > 0) {
                    clearTimeout(_this.timer);
                }
                _this.timer = setTimeout(function () { return _this.setState({ width: width_1, height: height_1 }); }, _this.delay);
            }
        };
        ...
        _this.componentDidUpdate = function (prevProps, prevState) {
            if (_this.props.url !== prevProps.url || _this.state !== prevState) {
                _this.draw(_this.props.url);
            }
        };
